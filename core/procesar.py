...
def transcribir_audio(audio_path: str) -> str:
    """Transcribe el audio usando Claude directamente."""
    print("  🎤 Transcribiendo audio con Claude...")
    try:
        ...
        respuesta = client.messages.create(
            ...
            messages=[{
                ...
                "content": [
                    ...
                    {
                        "type": "text",
                        "text": "Transcribe exactamente lo que dice esta grabación de audio en español. Solo devuelve la transcripción, sin comentarios adicionales."
                    }
                ]
            }]
        )
